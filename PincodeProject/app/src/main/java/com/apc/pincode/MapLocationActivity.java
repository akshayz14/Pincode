...
public class MapLocationActivity extends AppCompatActivity
    ...
    private Button btnchangeGeofenceAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPreferences = getSharedPreferences(AppConstants.PREF_NAME, Context.MODE_PRIVATE);
...
//                ft.replace(R.id.mapContainer, new HomeAddressFragment(), "HomeAddressFragment");
...
//        });
    ...
    public static Intent makeNotificationIntent(Context context, String msg) {
        ...
        intent.putExtra("geofence message", msg);
        return intent;
    }
    ...
    public void onConnected(Bundle bundle) {
        ...
        mLocationRequest.setInterval(3 * 60 * 1000);
...
//        editor.putString(AppConstants.USER_ADDRESS, address);
//        editor.apply();
    ...
    private String getCompleteAddressString(double LATITUDE, double LONGITUDE) {
        ...
        try {
            ...
            if (addresses != null) {
                ...
                Log.w("My Current add ", strReturnedAddress.toString());
            } else {
                Log.e("My Current add ", "No Address returned!");
            }
        } catch (Exception e) {
            e.printStackTrace();
